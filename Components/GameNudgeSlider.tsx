...
const GameNudgeSlider: React.FC<GameNudgeSliderProps> = ({
  ...
  const completionRate = totalCount > 0 ? Math.round((reactedCount / totalCount) * 100) : 0;
  ...
  return (
    <div style={{
      background: isMobile ? 'transparent' : 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>{reactedCount}/{totalCount} completed • {completionRate}%</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        {currentIndex + 1} of {notifications.length} • {getTimeAgo(currentNotification.createdAt)}
      </div>
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            background: currentIndex === 0 ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.9)',
        ...
        <button
          ...
          style={{
            background: currentIndex === notifications.length - 1 ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.9)',
            color: currentIndex === notifications.length - 1 ? 'rgba(255,255,255,0.5)' : '#4f46e5',
            border: 'none',
            borderRadius: '0.5rem',
            padding: 'clamp(0.5rem, 1.5vw, 0.75rem) clamp(0.75rem, 2vw, 1rem)',
            cursor: currentIndex === notifications.length - 1 ? 'not-allowed' : 'pointer',
            fontWeight: 'bold',
            fontSize: 'clamp(0.7rem, 1.8vw, 0.8rem)',
            minHeight: '40px',
            minWidth: '60px'
