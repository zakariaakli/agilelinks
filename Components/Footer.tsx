        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerSection}>
            <div className={styles.brandSection}>
              <div className={styles.logoSection}>
                <img src="/logo.jpg" alt="AgileLinks Logo" className={styles.footerLogo} />
                <div className={styles.brandName}>AgileLinks</div>
              </div>
              <p className={styles.brandDescription}>
                Empowering personal growth through intelligent coaching and personalized insights.
                Discover your potential and achieve your goals with personalized guidance.
              </p>
          ...
          <div className={styles.footerSection}>
            ...
            <ul className={styles.linkList}>
              <li><Link href="/" className={styles.footerLink}>Enneagram Test</Link></li>
              <li><Link href="/profile/companion" className={styles.footerLink}>Goal Planner</Link></li>
              <li><Link href="/articles" className={styles.footerLink}>Insights & Articles</Link></li>
              <li><Link href="/profile" className={styles.footerLink}>Personal Dashboard</Link></li>
            </ul>
          </div>
          ...
          <div className={styles.footerSection}>
            ...
            <p className={styles.newsletterDescription}>
              Get the latest insights on personal development and goal achievement.
            </p>
