      ...
      <div className={styles.stepContent}>
        ...
        <div className={styles.ctaBox}>
          ...
          <div className={styles.ctaButtons}>
            ...
            <a href="/profile/companion" className={styles.secondaryBtn}>
              Create a Goal
            </a>
          </div>
        </div>
...
export default function WelcomePage() {
  const [activeTab, setActiveTab] = useState<Tab>("howToUse");
  const [currentStep, setCurrentStep] = useState(0);

  const steps = activeTab === "howToUse" ? howToUseSteps : setupGuideSteps;
    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.tabMenu}>
          <button
            className={`${styles.tabButton} ${activeTab === "howToUse" ? styles.activeTabButton : ""}`}
            onClick={() => handleTabSwitch("howToUse")}
          >
            How to Use Stepiva
          </button>
          <button
            className={`${styles.tabButton} ${activeTab === "setupGuide" ? styles.activeTabButton : ""}`}
            onClick={() => handleTabSwitch("setupGuide")}
          >
            Setup Guide
          </button>
        </div>
